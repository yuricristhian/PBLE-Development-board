...
*/
inline static void RB12_SetValue(bool value)
{
  if(value)
  {
    RB12_High();
...
*/
#define RB12_Toggle()           ( LATBINV = (1 << 12) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB12
    postValue = RB12_GetValue();
    </code>

*/
#define RB12_Get()         PORTBbits.RB12
/**
  @Summary
  ...
  @Example
    ...
    RB12_SetDigitalInput();
    </code>

*/
#define RB12_In()   ( TRISBSET = (1 << 12) )
/**
  @Summary
  ...
  @Example
    ...
    RB12_SetDigitalOutput();
    </code>

*/
#define RB12_Out()   ( TRISBCLR = (1 << 12) )
/**
  @Summary
...
*/
inline static void RB13_SetValue(bool value)
{
  if(value)
  {
    RB13_High();
...
*/
#define RB13_Toggle()           ( LATBINV = (1 << 13) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB13
    postValue = RB13_GetValue();
    </code>

*/
#define RB13_Get()         PORTBbits.RB13
/**
  @Summary
  ...
  @Example
    ...
    RB13_SetDigitalInput();
    </code>

*/
#define RB13_In()   ( TRISBSET = (1 << 13) )
/**
  @Summary
  ...
  @Example
    ...
    RB13_SetDigitalOutput();
    </code>

*/
#define RB13_Out()   ( TRISBCLR = (1 << 13) )
/**
  @Summary
